...
D:/Bitnami/wampstack-8.1.2-0/apache2/htdocs
...
You should copy the "demo" folder into the D:/Bitnami/wampstack-8.1.2-0/apps 
folder and add the following line at the end of the
D:/Bitnami/wampstack-8.1.2-0/apache2/conf/bitnami/bitnami-apps-prefix.conf

Include "D:/Bitnami/wampstack-8.1.2-0/apps/demo/conf/httpd-prefix.conf"
...
configuration in the "D:/Bitnami/wampstack-8.1.2-0/apache2/conf/bitnami/bitnami-apps-prefix.conf" file

#Include "D:/Bitnami/wampstack-8.1.2-0/apps/demo/conf/httpd-prefix.conf"

and enable the new Virtual Host configuration file in the 
"D:/Bitnami/wampstack-8.1.2-0/apache2/conf/bitnami/bitnami-apps-vhosts.conf" file:

Include "D:/Bitnami/wampstack-8.1.2-0/apps/demo/conf/httpd-vhosts.conf"
